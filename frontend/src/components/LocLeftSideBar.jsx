...
const LocLeftSideBar = ({  setSelectedSection, selectedSection  }) => {
  return (
    <div className='w-1/5 min-h-screen bg-gray-200 px-[20px] py-[20px] flex flex-col justify-between'>
      <div>
    ...
    <button 
          ...
          <button 
            className={`pl-[1.5em] block py-[0.5em] w-full text-left px-[10px]  rounded-[100px] 
              ${selectedSection === 'requests' ? 'bg-[#750000] text-white' : 'bg-transparent text-black'}`}
